      ...
      <el-row>
        <el-col :span="12">
          <el-form-item label="排序" prop="menuSort">
            <el-input v-model="dataForm.menuSort" placeholder="排序" clearable/>
          </el-form-item>
        </el-col>
        <el-col :span="12">
          <el-form-item label="系统id" prop="sysId">
            <el-input v-model="dataForm.sysId" placeholder="系统id" clearable/>
          </el-form-item>
        </el-col>
      </el-row>
      <el-row>
        ...
        <el-col :span="12">
          <el-form-item label="MenuType" prop="menuType">
            <el-input v-model="dataForm.menuType" placeholder="MenuType" clearable/>
          </el-form-item>
        </el-col>
      </el-row>
      <el-row>
        <el-col :span="12">
          <el-form-item label="连接href" prop="meenuHref">
            <el-input v-model="dataForm.meenuHref" placeholder="连接href" clearable/>
          </el-form-item>
        </el-col>
        <el-col :span="12">
  ...
  methods: {
    ...
    dataFormSubmit() {
      this.$refs['dataForm'].validate((valid) => {
        if (valid) {
          this.$http({
            url: this.$http.adornUrl(`/sysmenuitem/${!this.flag ? 'add' : 'update'}`),
            method: 'post',
